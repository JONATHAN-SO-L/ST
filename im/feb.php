...
<?php
  ...
  include "../../funciones/conexion.php";
    ...
    $resultado = mysqli_query($conexion,"SELECT EXISTS (SELECT * FROM febrero);");
    $row=mysqli_fetch_row($resultado);

      if ($row[0]=="1") {

        $resultado = mysqli_query($conexion, "SELECT * FROM febrero");
      ...
      echo "
              <div class='container'> 
                ...
                <div class='form-group'>
                  <center>
                  <a href='/st/sistema/im/mod2.php' class='btn active btn-warning' style='color:white;'>MODIFICAR INFORME</a>
                  </center>
                </div>
              </div>
            <br><br>";}
...
<br>';
        ...
        $conexion->query("INSERT INTO febrero (publicaciones, videos, horas, revisitas, cursos, comentarios) VALUES ('$pubs', '$videos', '$hours', '$revisit', '$courses', '$comments')");
